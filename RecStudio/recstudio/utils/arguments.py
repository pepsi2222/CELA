...
def get_default_parser() -> ArgumentParser:
    ...
    group.add_argument('--dataset', '-d', type=str, default='Toys', help='dataset name')
    group.add_argument('--data_config_path', type=str, default='/root/autodl-tmp/xingmei/LM4REC/RecStudio/recstudio/data/config/Toys_and_Games.yaml', help='path of datasets config file')
